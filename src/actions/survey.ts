...
export async function submitSurvey(
  ...
  const parsed = surveySchema.safeParse({
    ...
    proposedRoles: formData.getAll("proposedRoles") as string[],
    venueCapacity: formData.get("venueCapacity") ?? "",
    foodArrangementNotes: formData.get("foodArrangementNotes") ?? "",
    isDirectlyOnRoute: formData.get("isDirectlyOnRoute") === "on",
    offRouteReason: formData.get("offRouteReason") ?? "",
    supportCategories: formData.getAll("supportCategories") as string[],
    distanceFromRouteKm: formData.get("distanceFromRouteKm") ?? "",
    contactName: formData.get("contactName") ?? "",
    contactPhone: formData.get("contactPhone") ?? "",
    contactRole: formData.get("contactRole") ?? "",
    institutionWebsite: formData.get("institutionWebsite") ?? "",
  ...
  const [created] = await db
    ...
    .values({
      ...
      foodArrangementNotes: data.foodArrangementNotes,
      isDirectlyOnRoute: data.isDirectlyOnRoute,
      offRouteReason: data.offRouteReason,
      supportCategories: data.supportCategories,
      distanceFromRouteKm: data.distanceFromRouteKm,
